...
SIMILARITY_THRESHOLD = _get_nested(_PARAMS, "retrieval", "similarity_threshold", default=0.35)
...
CAG_SIMILARITY_THRESHOLD = _get_nested(_PARAMS, "cag", "similarity_threshold", default=0.65)
...
def get_log_level() -> str:
    """Prefer LOG_LEVEL env var, then param.yaml logging.level."""
    return (os.getenv("LOG_LEVEL") or LOG_LEVEL).upper()


# ========================================
# Voice Pipeline (from param.yaml)
# ========================================
...
VOICE_TTS_VOICE_ID = _get_nested(_PARAMS, "voice", "tts_voice_id", default="")
VOICE_VAD_THRESHOLD = _get_nested(_PARAMS, "voice", "vad_threshold", default=0.5)
VOICE_SILENCE_THRESHOLD_MS = _get_nested(_PARAMS, "voice", "silence_threshold_ms", default=500)
VOICE_MIN_ENDPOINTING_DELAY = _get_nested(_PARAMS, "voice", "min_endpointing_delay", default=0.5)
