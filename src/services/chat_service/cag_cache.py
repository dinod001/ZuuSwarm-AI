...
How it works:
    1. Every cached entry is a Qdrant point containing:
       ...
       - **payload.source_file** : JSON-encoded source list
...
class CAGCache:
    ...
    Each point stores:
        ...
        payload  → query, answer, source_file, ts
    ...
    Usage::
        ...
        cache.set("What is the leave policy?", {"answer": "...", "source_file": [...]})
    """
    ...
    def get(self, query: str) -> Optional[Dict[str, Any]]:
        ...
        Returns:
            Dict with ``query``, ``answer``, ``source_file``, ``ts``,
    ...
    def set(self, query: str, response: Dict[str, Any]) -> None:
        ...
        Args:
            ...
            response: Dict with ``answer`` and optionally ``source_file``.
        """
        if not self._available:
            return
